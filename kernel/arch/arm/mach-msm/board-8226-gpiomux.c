...
static struct msm_gpiomux_config msm_sensor_configs_SHELLW[] __initdata = {
        {
                .gpio = 22, /* CAM1_VDD */
                .settings = {
                        [GPIOMUX_ACTIVE]    = &cam_settings[3],
...
static struct gpiomux_setting lcd_5v_cfg = {
	.func = GPIOMUX_FUNC_GPIO,
	.drv = GPIOMUX_DRV_2MA,
	.pull = GPIOMUX_PULL_UP,
	.dir = GPIOMUX_OUT_HIGH,
};
static struct msm_gpiomux_config msm_lcd_configs_SHELLEW[] __initdata = {
        {
                .gpio = 27, /* LCD +5V ENP */
                .settings = {
                        [GPIOMUX_ACTIVE]    = &lcd_5v_cfg,
                        [GPIOMUX_SUSPENDED] = &lcd_5v_cfg,
                },
        },
        {
                .gpio = 34, /* LCD -5V ENN */
...
void __init msm8226_init_gpiomux(void)
{
	...
	//for SHELLW project
	msm_gpiomux_install(msm_sensor_configs_SHELLW,
		ARRAY_SIZE(msm_sensor_configs_SHELLW));
	...
	printk("###################product shellEW####################");
	msm_gpiomux_install(msm_lcd_configs_SHELLEW,
			ARRAY_SIZE(msm_lcd_configs_SHELLEW));
