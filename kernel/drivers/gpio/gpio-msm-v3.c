...
/* (for K6) yangjq, 20130515, Add sysfs for gpio's debug, START */
/* (for msm8610) wangzheng4, 20131113, merged */

#define TLMM_NUM_GPIO 102
...
/* (for K6) yangjq, 20130515, Add sysfs for gpio's debug, END */
/* (for msm8610) wangzheng4, 20131113, merged */
