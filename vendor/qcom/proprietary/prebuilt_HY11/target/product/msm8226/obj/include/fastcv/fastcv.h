...
FastCV 1.4.0 supports Android and Windows mobile developers.
FastCV 1.4.0 is available for download for free from developer.qualcomm.com.

FastCV 1.4.0 is released as a unified binary, a single binary containing two
...
//---------------------------------------------------------------------------
/// @brief
///   NxN correlation with seperable kernel.
///
///   \n\b ATTENTION: This function is in the extension lib.
///
/// @param kernel
...
///   WARNING: must be multiple of 8, and at least as much as srcWidth*numChannel if not 0.
///
/// @param numChannel
...
///   WARNING: must be multiple of 8, and at least as much as srcWidth*4 if not 0.
///
/// @param data
...
///
/// @param srcWidth
///    Width of the input image, the number of pixels in a row. Must be a multiple of 8.
///
/// @param srcHeight
...
///   column 0 of row 2 in data memory.
///   \n\b NOTE: if 0, srcStride is set as srcWidth*3.
///   \n\b WARNING: must be multiple of 8 (8 * 1-byte values), and at least as
...
///   column 0 of row 2 in data memory.
///   \n\b NOTE: if 0, dstStride is set as dstWidth*3.
///   \n\b WARNING: must be multiple of 8 (8 * 1-byte values), and at least
...
/// @param gradStride
///   Stride is the number of bytes between column 0 of row 1 and
///   column 0 of row 2 in data memory. this is the stride of the image.
///
/// @param topLeftX
