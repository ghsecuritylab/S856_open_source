...
int validate_system_app_path(const char* path) {
    ...
    if(actualpath!=NULL)
    {	
		//it pointing /preload app, so, think it's system app
        if( !strncmp(actualpath,"/preload",strlen("/preload")) ){
			return 0;
		}
...
// Begin lenovo-sw yinzl1 2014/5/22 SHELLROW-186
...
// End lenovo-sw yinzl1 2014/5/22 SHELLROW-186
